# Capability: xstudio-viewport-sync

Viewport Display Synchronization for xStudio, including two-way synchronization of viewport zoom, pan, exposure, and channel selection with other active review sessions.
