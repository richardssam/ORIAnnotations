# ORI Session Management Specification
...
- **WHEN** the user presses Enter in the Session Name field
- **THEN** the dialog SHALL confirm (equivalent to clicking Connect/OK)
