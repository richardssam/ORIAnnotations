# xs-media-uuid-mapping

## Purpose

Defines how the xStudio sync plugin maintains a session-local mapping between OTIO sync GUIDs and live xStudio media objects, replacing fragile name-based `playlist.media` scans with stable, O(1) UUID lookups.
