...
The refactor SHALL NOT degrade the throughput of high-frequency message paths, specifically partial-annotation streaming and playback-state broadcasts. Construction and serialization of these messages SHALL avoid added per-message validation or reflective traversal.
